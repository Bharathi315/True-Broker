...
import 'step4_home.dart';
import 'step2_home.dart';



class Step3Home extends StatefulWidget {
  const Step3Home({super.key});

  @override
  State<Step3Home> createState() => _Step3HomeState();
}

class _Step3HomeState extends State<Step3Home> {
  ...
  void _validateAndProceed() {
    ...
    if (hasError) {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => Step4Home()),
      );
    }
  }
