...
import 'package:truebroker/home/home_filter.dart';
import 'dart:async';
            ...
            SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ListView(
                      ...
                      children: [
                        ...
                        _buildCityItem(pw, ph, "Thanjavur", "assets/Home screen/Thanjavur.png"),
                        _buildCityItem(pw, ph, "Salem", "assets/Home screen/Salem.png"),
                        _buildCityItem(pw, ph, "Coimbatore", "assets/Home screen/Coimbatore.png"),
                        _buildCityItem(pw, ph, "Erode", "assets/Home screen/erode.png"),
                        _buildCityItem(pw, ph, "Karur", "assets/Home screen/karur.png"),
                        _buildCityItem(pw, ph, "Theni", "assets/Home screen/theni.png"),
                        _buildCityItem(pw, ph, "Ranipet", "assets/Home screen/ranipet.png"),
                        _buildCityItem(pw, ph, "Tenkasi", "assets/Home screen/tenkasi.png"),
                        _buildCityItem(pw, ph, "Vellore", "assets/Home screen/vellore.png"),
                        _buildCityItem(pw, ph, "Dindigul", "assets/Home screen/dindigul.png"),
                        _buildCityItem(pw, ph, "Namakkal", "assets/Home screen/namakkal.png"),
                        _buildCityItem(pw, ph, "Nilagiri", "assets/Home screen/nilagiri.png"),
                        _buildCityItem(pw, ph, "Tiruppur", "assets/Home screen/tiruppur.png"),
                        _buildCityItem(pw, ph, "Ariyalur", "assets/Home screen/ariyallur.png"),
                        _buildCityItem(pw, ph, "Cuddalore", "assets/Home screen/cuddalore.png"),
                        _buildCityItem(pw, ph, "Sivaganga", "assets/Home screen/sivaganga.png"),
                        _buildCityItem(pw, ph, "Dharmapuri", "assets/Home screen/dharmapuri.png"),
                        _buildCityItem(pw, ph, "Perambalur", "assets/Home screen/perambalur.png"),
                        _buildCityItem(pw, ph, "Thiruvarur", "assets/Home screen/Thiruvarur.png"),
                        _buildCityItem(pw, ph, "Tiruvallur", "assets/Home screen/tiruvallur.png"),
                        _buildCityItem(pw, ph, "Viluppuram", "assets/Home screen/viluppuram.png"),
                        _buildCityItem(pw, ph, "Kanchipuram", "assets/Home screen/kanchipuram.png"),
                        _buildCityItem(pw, ph, "Krishnagiri", "assets/Home screen/krishnagiri.png"),
                        _buildCityItem(pw, ph, "Pudukkottai", "assets/Home screen/pudukkottai.png"),
                        _buildCityItem(pw, ph, "Thirupathur", "assets/Home screen/thirupathur.png"),
                        _buildCityItem(pw, ph, "Tirunelveli", "assets/Home screen/tirunelveli.png"),
                        _buildCityItem(pw, ph, "Chengalpattu", "assets/Home screen/chengalpattu.png"),
                        _buildCityItem(pw, ph, "Nagappatinam", "assets/Home screen/nagappatinam.png"),
                        _buildCityItem(pw, ph, "Virudhunagar", "assets/Home screen/virudhunagar.png"),
                        _buildCityItem(pw, ph, "Kallakkurichi", "assets/Home screen/kallakkurichi.png"),
                        _buildCityItem(pw, ph, "Kanniyakumari", "assets/Home screen/kanniyakumari.png"),
                        _buildCityItem(pw, ph, "Mayiladuthurai", "assets/Home screen/mayiladuthurai.png"),
                        _buildCityItem(pw, ph, "Ramanathapuram", "assets/Home screen/ramanathapuram.png"),
                        _buildCityItem(pw, ph, "Thiruvannamalai", "assets/Home screen/Thiruvannamalai.png"),
                        _buildCityItem(pw, ph, "Thiruchirappalli", "assets/Home screen/thiruchirappalli.png"),
                      ],
                    ),
                  ),
                  ...
                  SizedBox(height: ph(80)), // Space for the bottom navigation bar
                ],
              ),
            ),
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => CreditCoinPlansScreen(), // your coin page
                              ),
                            );
                          },
                          child: Image.asset(
                            'assets/Home screen/Appbar4.png',
                            width: pw(24),
                            height: ph(24),
                          ),
                        ),
