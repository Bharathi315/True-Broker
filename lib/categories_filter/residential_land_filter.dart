...
final List<FilterCategory> filterCategories = [
  ...
  FilterCategory(
    ...
    label: 'By Land Type',
    options: [
      FilterOption(label: 'Residential Plot'),
      FilterOption(label: 'Commercial Land'),
      FilterOption(label: 'Agricultural Land'),
      FilterOption(label: 'Farm Land'),
      FilterOption(label: 'Villa Plot'),
    ],
  ),
  FilterCategory(
    key: 'plot_size',
    label: 'By Plot Size',
    options: [
      FilterOption(label: 'Below 600 Sq.ft'),
      FilterOption(label: '600 – 1200 Sq.ft'),
      FilterOption(label: '1200 – 2400 Sq.ft'),
      FilterOption(label: '2400 – 5000 Sq.ft'),
  ...
  FilterCategory(
    ...
    options: [
      ...
      FilterOption(label: 'Panchayat Approved'),
  ...
  FilterCategory(
    ...
    options: [
      ...
      FilterOption(label: 'Gated Community'),
      FilterOption(label: 'Open Land'),
      FilterOption(label: 'Layout Plot'),
    ],
  ),
];
...
void showResidentialLandFilterSheet(
