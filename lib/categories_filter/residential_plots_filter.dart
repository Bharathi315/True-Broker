...
final List<FilterCategory> filterCategories = [
  ...
  FilterCategory(
    ...
    options: [
      ...
      FilterOption(label: 'Gated Community Plot'),
      FilterOption(label: 'Corner Plot'),
      FilterOption(label: 'Mixed Use Plot'),
    ],
  ),
  FilterCategory(
    key: 'plot_size',
    ...
    options: [
      ...
      FilterOption(label: 'Above 4000 Sq.ft'),
    ],
  ),
  FilterCategory(
    key: 'approval',
  ...
  FilterCategory(
    ...
    options: [
      ...
      FilterOption(label: 'Open Plot'),
      FilterOption(label: 'Main Road Facing'),
      FilterOption(label: 'Near Commercial Zone'),
    ],
  ),
  FilterCategory(
    key: 'listed_by',
...
void showResidentialPlotsFilterSheet(
