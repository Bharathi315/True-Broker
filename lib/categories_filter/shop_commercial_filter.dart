...
final List<FilterCategory> filterCategories = [
  FilterCategory(
    ...
    label: 'By Budget',
    options: [
      FilterOption(label: 'Below 10 Lakhs'),
      FilterOption(label: '10 – 25 Lakhs'),
      FilterOption(label: '25 – 50 Lakhs'),
      FilterOption(label: '50 Lakhs – 1 Cr'),
      FilterOption(label: 'Above 1 Cr'),
    ],
  ),
  FilterCategory(
    key: 'shop_type',
    label: 'By Shop Type',
    options: [
      FilterOption(label: 'Retail Shop'),
      FilterOption(label: 'Showroom'),
      FilterOption(label: 'Mall Shop'),
      FilterOption(label: 'Street Shop'),
      FilterOption(label: 'Commercial Outlet'),
    ],
  ),
  FilterCategory(
    key: 'area_size',
    label: 'By Area Size',
    options: [
      FilterOption(label: 'Below 200 Sq.ft'),
      FilterOption(label: '200 – 500 Sq.ft'),
      FilterOption(label: '500 – 1000 Sq.ft'),
      FilterOption(label: '1000 – 2000 Sq.ft'),
      FilterOption(label: 'Above 2000 Sq.ft'),
    ],
  ),
  FilterCategory(
    key: 'floor',
  ...
  FilterCategory(
    ...
    label: 'By Furnishing',
    options: [
      FilterOption(label: 'Fully Furnished'),
      FilterOption(label: 'Semi Furnished'),
      FilterOption(label: 'Unfurnished'),
    ],
  ),
  FilterCategory(
    key: 'facing',
...
void showShopCommercialFilterSheet(
