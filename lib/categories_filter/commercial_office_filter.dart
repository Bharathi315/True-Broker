...
final List<FilterCategory> filterCategories = [
  FilterCategory(
    ...
    options: [
      ...
      FilterOption(label: '1 – 3 Cr'),
      FilterOption(label: 'Above 3 Cr'),
    ],
  ),
  FilterCategory(
    key: 'office_type',
    ...
    options: [
      FilterOption(label: 'IT Office'),
      FilterOption(label: 'Corporate Office'),
      FilterOption(label: 'Co-working Space'),
      FilterOption(label: 'Business Center'),
      FilterOption(label: 'Commercial Office Space'),
    ],
  ),
  FilterCategory(
    key: 'area_size',
    label: 'By Area Size',
    options: [
      FilterOption(label: 'Below 500 Sq.ft'),
      FilterOption(label: '500 – 1000 Sq.ft'),
      FilterOption(label: '1000 – 2000 Sq.ft'),
      FilterOption(label: '2000 – 5000 Sq.ft'),
      FilterOption(label: 'Above 5000 Sq.ft'),
    ],
  ),
  FilterCategory(
    key: 'floor',
    label: 'By Floor',
    options: [
      FilterOption(label: 'Ground Floor'),
      FilterOption(label: '1st Floor'),
      FilterOption(label: '2nd Floor'),
      FilterOption(label: '3rd Floor & Above'),
    ],
  ),
  FilterCategory(
    key: 'cabins',
    label: 'By Cabin / Rooms',
    options: [
      FilterOption(label: 'Open Workspace'),
      FilterOption(label: '1 Cabin'),
      FilterOption(label: '2 Cabins'),
      FilterOption(label: '3+ Cabins'),
      FilterOption(label: 'Conference Room Available'),
    ],
  ),
  FilterCategory(
    key: 'facing',
  ...
  FilterCategory(
    ...
    label: 'By Parking',
    options: [
      FilterOption(label: 'No Parking'),
      FilterOption(label: 'Bike Parking'),
      FilterOption(label: 'Car Parking'),
      FilterOption(label: 'Both Available'),
    ],
  ),
  FilterCategory(
    key: 'listed_by',
...
void showCommercialOfficeFilterSheet(
