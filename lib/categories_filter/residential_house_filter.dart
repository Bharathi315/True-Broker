...
final List<FilterCategory> filterCategories = [
  FilterCategory(
    ...
    label: 'By BHK',
    options: [
      FilterOption(label: '1 BHK', count: '5 Items'),
      FilterOption(label: '2 BHK', count: '10+ Items'),
      FilterOption(label: '3 BHK', count: '3 Items'),
      FilterOption(label: '4 BHK', count: '0 Items'),
      FilterOption(label: '4+ BHK', count: '1 Items'),
    ],
  ),
  FilterCategory(
    key: 'bathroom',
    label: 'By Bathroom',
    options: [
      FilterOption(label: '1 Bathroom', count: '5 Items'),
      FilterOption(label: '2 Bathroom', count: '10+ Items'),
      FilterOption(label: '3 Bathroom', count: '3 Items'),
      FilterOption(label: '4 Bathroom', count: '0 Items'),
      FilterOption(label: '4+ Bathroom', count: '1 Items'),
    ],
  ),
  FilterCategory(
    key: 'budget',
  ...
  FilterCategory(
    ...
    label: 'By Facing',
    options: [
      FilterOption(label: 'East', count: '5 Items'),
      FilterOption(label: 'West', count: '10+ Items'),
      FilterOption(label: 'North', count: '3 Items'),
      FilterOption(label: 'South', count: '0 Items'),
      FilterOption(label: 'North-East', count: '1 Items'),
      FilterOption(label: 'North-West', count: '10+ Items'),
      FilterOption(label: 'South-East', count: '3 Items'),
      FilterOption(label: 'South-West', count: '0 Items'),
    ],
  ),
  FilterCategory(
    key: 'property',
    label: 'By Property',
    options: [
      FilterOption(label: 'Flats/Apartment', count: '5 Items'),
      FilterOption(label: 'House & Villa', count: '10+ Items'),
      FilterOption(label: 'Farm House', count: '3 Items'),
      FilterOption(label: 'Duplex', count: '0 Items'),
    ],
  ),
  FilterCategory(
    key: 'parking',
    label: 'By Car Parking',
    options: [
      FilterOption(label: '0', count: '5 Items'),
      FilterOption(label: '1', count: '10+ Items'),
      FilterOption(label: '2', count: '3 Items'),
      FilterOption(label: '3', count: '0 Items'),
      FilterOption(label: '3+', count: '1 Items'),
    ],
  ),
  FilterCategory(
    key: 'price',
    label: 'By Price Per Sqt',
    type: FilterType.range,
    rangeMin: 0,
    rangeMax: 150000,
    rangeHint: 'Choose a range below',
  ...
  FilterCategory(
    ...
    label: 'By Furnishing',
    options: [
      FilterOption(label: 'Furnished', count: '5 Items'),
      FilterOption(label: 'UnFurnished', count: '10+ Items'),
      FilterOption(label: 'SemiFurnished', count: '3 Items'),
    ],
  ),
  FilterCategory(
    key: 'status',
    label: 'By Project Status',
    type: FilterType.range,
    rangeMin: 0,
    rangeMax: 150000,
...
void showResidentialHouseFilterSheet(
