...
final List<FilterCategory> filterCategories = [
  FilterCategory(
    ...
    label: 'By Budget',
    options: [
      FilterOption(label: 'Below 50 Lakhs'),
      FilterOption(label: '50 Lakhs – 1 Cr'),
      FilterOption(label: '1 – 2 Cr'),
      FilterOption(label: '2 – 5 Cr'),
  ...
  FilterCategory(
    ...
    label: 'By BHK',
    options: [
      FilterOption(label: '1 BHK'),
      FilterOption(label: '2 BHK'),
      FilterOption(label: '3 BHK'),
      FilterOption(label: '4 BHK'),
      FilterOption(label: '5+ BHK'),
    ],
  ),
  FilterCategory(
    key: 'bathroom',
    label: 'By Bathroom',
    options: [
      FilterOption(label: '1 Bathroom'),
      FilterOption(label: '2 Bathrooms'),
      FilterOption(label: '3 Bathrooms'),
      FilterOption(label: '4+ Bathrooms'),
    ],
  ),
  FilterCategory(
    key: 'plot_size',
    label: 'By Plot Size',
    options: [
      FilterOption(label: 'Below 1200 Sq.ft'),
      FilterOption(label: '1200 – 2400 Sq.ft'),
      FilterOption(label: '2400 – 4000 Sq.ft'),
      FilterOption(label: '4000+ Sq.ft'),
    ],
  ),
  FilterCategory(
    key: 'built_up_area',
    label: 'By Built-up Area',
    options: [
      FilterOption(label: 'Below 1000 Sq.ft'),
      FilterOption(label: '1000 – 2000 Sq.ft'),
      FilterOption(label: '2000 – 3000 Sq.ft'),
      FilterOption(label: '3000+ Sq.ft'),
    ],
  ),
  FilterCategory(
    key: 'facing',
  ...
  FilterCategory(
    ...
    options: [
      FilterOption(label: 'Independent Villa'),
      FilterOption(label: 'Gated Community Villa'),
      FilterOption(label: 'Duplex Villa'),
      FilterOption(label: 'Triplex Villa'),
    ],
  ),
  FilterCategory(
    key: 'listed_by',
...
void showResidentialVillaFilterSheet(
