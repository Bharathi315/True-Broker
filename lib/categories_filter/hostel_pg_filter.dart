...
final List<FilterCategory> filterCategories = [
  FilterCategory(
    ...
    label: 'By Gender',
    options: [
      FilterOption(label: 'Male', count: '5 Items'),
      FilterOption(label: 'Female', count: '10+ Items'),
      FilterOption(label: 'Any', count: '3 Items'),
    ],
  ),
  FilterCategory(
    key: 'sharing',
    label: 'By Sharing',
    options: [
      FilterOption(label: 'Single Sharing', count: '5 Items'),
      FilterOption(label: 'Double Sharing', count: '10+ Items'),
      FilterOption(label: 'Triple Sharing', count: '3 Items'),
      FilterOption(label: 'Four Sharing', count: '0 Items'),
      FilterOption(label: 'Four+ Sharing', count: '1 Items'),
    ],
  ),
  FilterCategory(
    key: 'budget',
  ...
  FilterCategory(
    ...
    label: 'By Food',
    options: [
      FilterOption(label: 'With Food', count: '5 Items'),
      FilterOption(label: 'Without Food', count: '10+ Items'),
    ],
  ),
  FilterCategory(
    key: 'amenities',
    label: 'By Amenities',
    options: [
      FilterOption(label: 'AC', count: '5 Items'),
      FilterOption(label: 'Wi-Fi', count: '10+ Items'),
      FilterOption(label: 'Washing Machine', count: '3 Items'),
      FilterOption(label: 'TV', count: '0 Items'),
      FilterOption(label: 'Power Backup', count: '1 Items'),
    ],
  ),
  FilterCategory(
    key: 'listed_by',
...
// ─── Show Hostel PG Filter Sheet ──────────────────────────────────────────────

void showHostelPGFilterSheet(
  ...
  showModalBottomSheet(
    ...
    builder: (_) => HostelPGFilterBottomSheet(onApply: onApply),
  );
}

// ─── HostelPGFilterBottomSheet ───────────────────────────────────────────────

class HostelPGFilterBottomSheet extends StatefulWidget {
  final void Function(Map<String, dynamic> result)? onApply;
  const HostelPGFilterBottomSheet({super.key, this.onApply});

  @override
  State<HostelPGFilterBottomSheet> createState() => _HostelPGFilterBottomSheetState();
}

class _HostelPGFilterBottomSheetState extends State<HostelPGFilterBottomSheet> {
