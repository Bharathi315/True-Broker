...
final List<FilterCategory> filterCategories = [
  FilterCategory(
    key: 'star_rating',
    label: 'By Star Rating',
    options: [
      FilterOption(label: '1 Star', count: '5 Items'),
      FilterOption(label: '2 Star', count: '10+ Items'),
      FilterOption(label: '3 Star', count: '3 Items'),
      FilterOption(label: '4 Star', count: '0 Items'),
      FilterOption(label: '5 Star', count: '1 Items'),
    ],
  ),
  FilterCategory(
    key: 'budget',
  ...
  FilterCategory(
    ...
    options: [
      FilterOption(label: 'Hotel', count: '5 Items'),
      FilterOption(label: 'Resort', count: '10+ Items'),
      FilterOption(label: 'Guest House', count: '3 Items'),
      FilterOption(label: 'Heritage Hotel', count: '0 Items'),
    ],
  ),
  FilterCategory(
    key: 'amenities',
    label: 'By Amenities',
    options: [
      FilterOption(label: 'Swimming Pool', count: '5 Items'),
      FilterOption(label: 'Gym', count: '10+ Items'),
      FilterOption(label: 'Restaurant', count: '3 Items'),
      FilterOption(label: 'Free Wi-Fi', count: '0 Items'),
      FilterOption(label: 'Spa', count: '1 Items'),
    ],
  ),
  FilterCategory(
    key: 'listed_by',
...
// ─── Show Hotel Filter Sheet ──────────────────────────────────────────────────

void showHotelFilterSheet(
  ...
  showModalBottomSheet(
    ...
    builder: (_) => HotelFilterBottomSheet(onApply: onApply),
  );
}
...
class HotelFilterBottomSheet extends StatefulWidget {
  ...
  const HotelFilterBottomSheet({super.key, this.onApply});
